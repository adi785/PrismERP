          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-10">
              ...
              <div className="bg-white rounded-[3.5rem] p-12 border border-slate-100 shadow-sm">
                ...
                <div className="space-y-8">
                  {items.map(item => {
                    ...
                    return (
                      <div key={item.id} className={`p-8 rounded-[3rem] border group relative hover:shadow-xl transition-all ${isOverReturn ? 'bg-rose-50 border-rose-200' : 'bg-slate-50/50 border-slate-100'}`} ref={activeSearchId === item.id ? searchRef : null}>
                        <div className="grid grid-cols-12 gap-8 items-end">
                          ...
                          <div className="col-span-2 text-center">
                            ...
                            <input 
                              type="number" 
                              className={`w-full px-4 py-5 rounded-2xl bg-white border-2 font-black text-base text-center outline-none ${isOverReturn ? 'border-rose-500' : 'border-slate-100'}`} 
                              value={item.quantity || ''} 
            ...
            <div className="space-y-10">
              ...
              <button 
                ...
                className="w-full py-10 bg-blue-600 hover:bg-blue-700 text-white rounded-[4rem] font-black text-2xl flex items-center justify-center gap-5 transition-all shadow-[0_40px_80px_-20px_rgba(37,99,235,0.5)] group disabled:opacity-50"
              >
