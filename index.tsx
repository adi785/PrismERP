  ...
  try {
    ...
    rootElement.innerHTML = `
      <div style="height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background: #0f172a; color: white; font-family: sans-serif; text-align: center; padding: 20px;">
        ...
        <button onclick="window.location.reload()" style="margin-top: 30px; border-radius: 8px; background-color: #4f46e5; color: white; padding: 10px 20px; font-weight: bold; border: none; cursor: pointer;">Retry Bootstrap</button>
      </div>
    `;
  }
}
